...
class ToggleComponent {
    ...
    constructor(_element: HTMLElement, options: ToggleOptions) {
        ...
        const elementToggleAttr = this.element.getAttribute(
            'data-kt-toggle-state'
        );
        this.state = elementToggleAttr || '';
        const elementModeAttr = this.element.getAttribute(
            'data-kt-toggle-mode'
        );
    ...
    private _isEnabled = () => {
        ...
        return (
            String(this.target.getAttribute(this.attribute)).toLowerCase() ===
            'on'
        );
    };
