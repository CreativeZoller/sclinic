...
type ResponseModel = UnResponse<UnObservable<ReturnType<ResourceManagementService["publishedScheduleGetPublishedScheduleByConditionPost"]>>>;
export type PublishedSchedule = UnArray<ResponseModel["publishedScheduleList"]>;