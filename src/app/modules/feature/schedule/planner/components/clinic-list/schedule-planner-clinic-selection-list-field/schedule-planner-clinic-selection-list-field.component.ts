...
@Component({
  selector: 'app-schedule-planner-clinic-selection-list-field',
  templateUrl: './schedule-planner-clinic-selection-list-field.component.html',
  styleUrls: ['./schedule-planner-clinic-selection-list-field.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  // Must set both providers & viewProviders fot @Host to work
  providers: SkipSettingValueAccessorProviders,
  viewProviders: SkipSettingValueAccessorProviders,
})
export class SchedulePlannerClinicSelectionListFieldComponent extends BaseSelectionListFieldComponent<Clinic> {
