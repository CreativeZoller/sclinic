...
@Component({
    selector: 'app-schedule-planner-substitute-doctor-form',
    templateUrl: './schedule-planner-substitute-doctor-form.component.html',
    styleUrls: ['./schedule-planner-substitute-doctor-form.component.scss']
})
export class SchedulePlannersubStituteDoctorFormComponent extends BaseFormComponent<MedicalEmployee> {
    ...
    public formValueToRequestValue(_value: any): any {
        ...
        return {
            ...
            dC_MedicalEmployeeScheduleTypeId: MedicalEmployeeTypeEnum.SUBSTITUDE_DOCTOR
        };
    }
}
