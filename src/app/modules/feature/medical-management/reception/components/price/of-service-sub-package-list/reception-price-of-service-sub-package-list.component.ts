...
import { ServiceSubPackage } from "../../../../../master-data/service-sub-packages/models/service-sub-package.model";
...
@UntilDestroy()
@Component({
    selector: "app-reception-price-of-service-sub-package-list",
    templateUrl: "./reception-price-of-service-sub-package-list.component.html",
    styleUrls: ["./reception-price-of-service-sub-package-list.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ReceptionPriceOfServiceSubPackageListComponent {
    ...
    public baseResourceKey = "reception.prices.modal.service.sub.package";
    ...
    protected tableHeaders$: Observable<TableHeader[]> = this.priceTemplates$.pipe(
        map((priceTemplates) => {
            return <TableHeader[]>[
                {
                    name: this.resourceService.resolve("reception.prices.modal.service.sub.package.list.table.headers.dC_SubServicePackageCategoryId"),
                    ...
                    initHeaderSearchComponentBindingsFn: (instance: SelectFieldComponent) => {
                        ...
                        instance.options = this.initData.dC_SubServicePackageCategoryList;
                        instance.writeValue(null);
                        instance.registerOnChange((v) => {
                            this.filterData$.next({
                                ...this.filterData$.value,
                                dC_SubServicePackageCategoryIdList: isEmpty(v) ? [] : [v],
                            });
                        });
                    },
                },
                {
                    name: this.resourceService.resolve("reception.prices.modal.service.sub.package.list.table.headers.servicePackageName"),
                ...
                {
                    name: this.resourceService.resolve("reception.prices.modal.service.sub.package.list.table.headers.basePrice"),
                ...
                // {
                //     name: this.resourceService.resolve("reception.prices.modal.service.sub.package.list.table.headers.basePriceEUR"),
