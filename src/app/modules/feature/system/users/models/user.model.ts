...
type ResponseModel = UnResponse<UnObservable<ReturnType<AuthenticationWebServiceService["userGetSwissUserByConditionPost"]>>>
export type User = UnArray<ResponseModel["businessObjectList"]>;
