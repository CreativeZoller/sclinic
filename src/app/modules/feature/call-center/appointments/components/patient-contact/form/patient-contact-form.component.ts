...
import { fullEmailValidator } from "src/app/modules/core/utility/validators/full-email.validator";
...
@UntilDestroy()
@Component({
    selector: "app-cc-patient-contact-form",
    templateUrl: "./patient-contact-form.component.html",
    styleUrls: ["./patient-contact-form.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CcPatientContactFormComponent extends BaseFormComponent<Full_Model> implements OnInit {
