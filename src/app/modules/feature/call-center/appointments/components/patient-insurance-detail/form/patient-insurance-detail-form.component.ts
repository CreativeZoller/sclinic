...
import { CoreModelsDTOsMasterDataMainTablesPartnerDTO } from "src/api/models";
...
@UntilDestroy()
@Component({
    selector: "app-cc-patient-insurance-detail-form",
    templateUrl: "./patient-insurance-detail-form.component.html",
    styleUrls: ["./patient-insurance-detail-form.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CcPatientInsuranceDetailFormComponent extends BaseFormComponent<Full_Model> {
