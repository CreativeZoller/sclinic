...
import { CoreModelsDTOsMasterDataDCTablesDCCityDTO } from "src/api/models";
import { DictionaryProviderWebServiceService } from "src/api/services";
...
@UntilDestroy()
@Component({
    selector: "app-cc-patient-address-form",
    templateUrl: "./patient-address-form.component.html",
    styleUrls: ["./patient-address-form.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CcPatientAddressFormComponent extends BaseFormComponent<Full_Model> implements OnInit {
