...
import { ServiceXBookingArea } from "../../../models/service-x-booking-area.model";
...
type Full_Model = ServiceXBookingArea;

@UntilDestroy()
@Component({
    selector: "app-service-booking-area-selection-list-field",
    templateUrl: "./service-booking-area-selection-list-field.component.html",
    styleUrls: ["./service-booking-area-selection-list-field.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
    // Must set both providers & viewProviders fot @Host to work
    providers: SkipSettingValueAccessorProviders,
    viewProviders: SkipSettingValueAccessorProviders,
})
export class ServiceBookingAreaSelectionListFieldComponent extends BaseSelectionListFieldComponent<Full_Model> {
