...
@UntilDestroy()
@Component({
    selector: "app-service-price-template-item-form",
    templateUrl: "./service-price-template-item-form.component.html",
    styleUrls: ["./service-price-template-item-form.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ServicePriceTemplateItemFormComponent  extends BaseFormComponent<Full_Model> {

    public errorResourceKeyPrefix = "service.price.template.item.form.errors";
