...
export class ServicePackageListComponent {
    ...
    public baseResourceKey = "service.package";
    ...
    protected tableHeaders$: Observable<TableHeader[]> = this.priceTemplates$.pipe(
        map((priceTemplates) => {
            return <TableHeader[]>[
                {
                    name: this.resourceService.resolve("service.package.list.table.headers.servicePackageName"),
                ...
                {
                    name: this.resourceService.resolve("service.package.list.table.headers.dC_ServicePackageCategoryId"),
                ...
                {
                    name: this.resourceService.resolve("service.package.list.table.headers.duration"),
                ...
                {
                    name: this.resourceService.resolve("service.package.list.table.headers.basePrice"),
                ...
                {
                    name: this.resourceService.resolve("service.package.list.table.headers.basePriceEUR"),
    ...
    public saveBookingAreasChanges() {
        // allow to save grid inline change with extraTitleRowPreButtonsTemplate
