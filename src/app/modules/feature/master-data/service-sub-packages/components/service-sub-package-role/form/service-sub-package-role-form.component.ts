...
@UntilDestroy()
@Component({
    selector: "app-service-sub-package-role-form",
    templateUrl: "./service-sub-package-role-form.component.html",
    styleUrls: ["./service-sub-package-role-form.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ServiceSubPackageRoleFormComponent extends BaseFormComponent<Full_Model> implements OnInit {

    public errorResourceKeyPrefix = "service.sub.package.role.form.errors";
