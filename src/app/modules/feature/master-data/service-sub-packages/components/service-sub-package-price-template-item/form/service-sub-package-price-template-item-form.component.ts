...
@UntilDestroy()
@Component({
    selector: "app-service-sub-package-price-template-item-form",
    templateUrl: "./service-sub-package-price-template-item-form.component.html",
    styleUrls: ["./service-sub-package-price-template-item-form.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ServiceSubPackagePriceTemplateItemFormComponent  extends BaseFormComponent<Full_Model> {

    public errorResourceKeyPrefix = "service.sub.package.price.template.item.form.errors";
