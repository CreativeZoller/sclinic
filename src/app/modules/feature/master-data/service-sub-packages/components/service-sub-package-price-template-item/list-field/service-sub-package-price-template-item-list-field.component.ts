...
import { ServiceSubPackageXPriceTemplateItem } from "../../../models/service-sub-package-x-price-template-item.model";
...
type Full_Model = ServiceSubPackageXPriceTemplateItem;

@UntilDestroy()
@Component({
    selector: "app-service-sub-package-price-template-item-list-field",
    templateUrl: "./service-sub-package-price-template-item-list-field.component.html",
    styleUrls: ["./service-sub-package-price-template-item-list-field.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
    // Must set both providers & viewProviders fot @Host to work
    providers: SkipSettingValueAccessorProviders,
    viewProviders: SkipSettingValueAccessorProviders,
})
export class ServiceSubPackagePriceTemplateItemListFieldComponent extends BaseListFieldComponent<Full_Model> implements AfterViewInit {

    private datePipe = inject(DatePipe);
    public baseResourceKey = "service.sub.package.price.template.item";
    ...
    public tableHeaders: TableHeader[] = [
        {
            name: this.resourceService.resolve("service.sub.package.price.template.item.list.table.headers.priceTemplate.priceTemplateName"),
            attributeName: "priceTemplate.priceTemplateName",
        },
        {
            name: this.resourceService.resolve("service.sub.package.price.template.item.list.table.headers.price"),
            attributeName: "price",
        },
        {
            name: this.resourceService.resolve("service.sub.package.price.template.item.list.table.headers.priceTemplate.startDate"),
            attributeName: "priceTemplate.startDate",
            formatterFn: (v) => this.datePipe.transform(v),
        },
        {
            name: this.resourceService.resolve("service.sub.package.price.template.item.list.table.headers.priceTemplate.endDate"),
    ...
    private readonly BASE_PRICE_PRICE_TEMPLATE$ = this._activePriceTable$.pipe(
        map((activePriceTable) => ({
            ...
            priceTemplateName: this.resourceService.resolve("service.sub.package.price.template.item.list.table.basePriceTemplateName"),
