...
import { ServiceSubPackageXServicePackage } from "../../../models/service-sub-package-x-service-package.model";
...
type Full_Model = ServiceSubPackageXServicePackage;

@UntilDestroy()
@Component({
    selector: "app-service-sub-package-service-package-list-field",
    templateUrl: "./service-sub-package-service-package-list-field.component.html",
    styleUrls: ["./service-sub-package-service-package-list-field.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
    // Must set both providers & viewProviders fot @Host to work
    providers: SkipSettingValueAccessorProviders,
    viewProviders: SkipSettingValueAccessorProviders,
})
export class ServiceSubPackageServicePackageListFieldComponent extends BaseListFieldComponent<Full_Model> {

    private masterDataManagementService = inject(MasterDataManagementService);

    public baseResourceKey = "service.sub.package.service.package";
    public tableIdProperty = "servicePackageXSubServicePackageId";
    @Input() public tableTitle: string;
    @Input() public tableTitleUseSectionSubtitle: boolean;

    public tableHeaders: TableHeader[] = [
        {
            name: this.resourceService.resolve("service.sub.package.service.package.list.table.headers.servicePackage.servicePackageName"),
            attributeName: "servicePackage.servicePackageName",
        },
        {
            name: this.resourceService.resolve("service.sub.package.service.package.list.table.headers.servicePackage.dC_ServicePackageCategoryId"),
        ...
        {
            name: this.resourceService.resolve("service.sub.package.service.package.list.table.headers.servicePackage.dC_ServicePackageTypeId"),
