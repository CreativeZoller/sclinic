...
@UntilDestroy()
@Component({
    selector: "app-item-x-price-template-item-form",
    templateUrl: "./item-x-price-template-item-form.component.html",
    styleUrls: ["./item-x-price-template-item-form.component.scss"],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ItemXPriceTemplateItemFormComponent  extends BaseFormComponent<Full_Model> {

    public errorResourceKeyPrefix = "item.price.template.item.form.errors";
