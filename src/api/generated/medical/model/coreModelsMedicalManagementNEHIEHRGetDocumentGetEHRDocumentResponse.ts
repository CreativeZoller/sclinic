...
export interface CoreModelsMedicalManagementNEHIEHRGetDocumentGetEHRDocumentResponse { 
    errorMessage?: string;
    errorMessages?: Array<CoreModelsNEHICommonNEHIErrorMessageDTO>;
    faultMessages?: Array<CoreModelsNEHICommonNEHIErrorMessageDTO>;
    status?: string;
    ehrDocument?: CoreModelsMedicalManagementNEHIEHRGetDocumentEHRDocument;
}