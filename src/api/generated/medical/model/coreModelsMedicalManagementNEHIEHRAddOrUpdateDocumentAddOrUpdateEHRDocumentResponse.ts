...
import { CoreModelsNEHICommonResult } from './coreModelsNEHICommonResult';

export interface CoreModelsMedicalManagementNEHIEHRAddOrUpdateDocumentAddOrUpdateEHRDocumentResponse { 
    errorMessage?: string;
    status?: CoreModelsNEHICommonResult;
    id?: string;
    version?: number;
